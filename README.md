...
### Mobile Experience
<p align="center">
  <img src="./screenshots/mobile-head-hero" width="300" alt="Mobile View">
  <img src="./screenshots/mobile-products" width="300" alt="Mobile View ">
  <img src="./screenshots/mobile-footer" width="300" alt="Mobile View ">
</p>
...
1. Clone the repository:
   ```bash
   git clone [https://github.com/your-username/acs-cosmetics.git](https://github.com/your-username/acs-cosmetics.git)